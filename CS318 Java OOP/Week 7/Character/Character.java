public class Character{
    ...
    private int calculateTotalAttack() {
        int totalAttack = (this.weapon01 == null) ? this.attackPower
                            : this.attackPower + this.weapon01.getDamageBonus();
        totalAttack = (this.weapon02 == null) ? totalAttack
                            : totalAttack + this.weapon02.getDamageBonus();
        return totalAttack;
    }
    public void attack(Character target) {
        ...
        System.out.println(this.name + " attacks "
            + target.getName() + " for " + damageDealt + " base damage.");
        target.takeDamage(damageDealt);
    }
    private int calculateTotalDefense () {
        int totalDefense = (this.Armor01 == null) ? this.defense
                        : this.defense + this.Armor01.getDefenseBonus();
        totalDefense = (this.Armor02 == null) ? totalDefense :
                        totalDefense + this.Armor02.getDefenseBonus();
        return totalDefense;
    }
    public void takeDamage(int amount) {
        ...
        System.out.println(this.name + " took " + damageTaken
            + " damage. (Defense: " + totalDefense + ")");
        if (!isAlive()) {
